...
pdf("figs/Fig_S6B.pdf", height = 5, width = 10)
plt
dev.off()
```
...
```
```{r eval=FALSE, include=FALSE}
pdf("figs/Fig_S6D.pdf", height = 5, width = 6.5)
plt
dev.off()
```
...
```{r eval=FALSE, include=FALSE}
pdf("figs/Fig_S6E.pdf", height = 5, width = 6.5)
plt
dev.off()
```
...
```{r Fig_S6F, fig.width=6.5, fig.height=5}
plt <- complexplot_gene_perturbation(genes_df, interest_df,
                              targets = targets,
                              lfsr_mat = fdr_mat, lfsr_name = "FDR",
...
```
```{r eval=FALSE, include=FALSE}
pdf("figs/Fig_S6F.pdf", height = 5, width = 6.5)
plt
dev.off()
```
...
```{r Fig_S6C, fig.height=5.5, fig.width=8}
...
```{r eval=FALSE, include=FALSE}
pdf("figs/Fig_S6C.pdf", height = 5.5, width = 8)
draw(map, heatmap_legend_side = "bottom")
dev.off()
```
