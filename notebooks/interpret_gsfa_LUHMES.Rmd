...
```{r Fig_S6A, fig.width=8.5, fig.height=5.5}
...
pdf("figs/Fig_5E.pdf", width=13, height=4)
dge_plt + theme(legend.position = "right")
dev.off()
```
...
Here are DESeq2 estimated effects of perturbations on marker genes (Figure S6C):

```{r Fig_S6C, fig.width=6.5, fig.height=5}
complexplot_gene_perturbation(genes_df, interest_df,
                              targets = targets,
                              lfsr_mat = fdr_mat, lfsr_name = "FDR",
...
MAST estimated effects of perturbations on marker genes (Figure S6D):

```{r Fig_S6D, fig.width=6.5, fig.height=5}
complexplot_gene_perturbation(genes_df, interest_df,
                              targets = targets,
                              lfsr_mat = fdr_mat, lfsr_name = "FDR",
...
SCEPTRE estimated effects of perturbations on marker genes (Figure S6E):

```{r Fig_S6E, fig.width=6.5, fig.height=5}
complexplot_gene_perturbation(genes_df, interest_df,
                              targets = targets,
                              lfsr_mat = fdr_mat, lfsr_name = "FDR",
...
```{r echo=FALSE}
enrich_res <- readRDS(paste0(wkdir, result_folder, "WebGestalt_ORA/GO_enrich_in_GSFA_DEGs.rds"))
```
...
```{r Fig_S6F, fig.height=5.5, fig.width=8}
...
```{r Fig_5F, fig.height=4, fig.width=7.5}
enrich_thres <- 0.05
